...
namespace RedisCache.Store
{
    public abstract class BaseCacheStore : ICacheStore
    {
        ...
        public abstract IList<T> GetAll<T>(Cache.Objects.ConnectionType connectionType, string[] sortFields, int? take, params Cache.Objects.ConnectionValue[] connectionValues);
        ...
        public abstract IList<string> GetAllKeys<T>(Cache.Objects.ConnectionType connectionType, string[] sortFields, int? take, params Cache.Objects.ConnectionValue[] connectionValues);
